...
return [
    ...
    */
    ...
    'name' => env('NOVA_APP_NAME', 'MontFlow'),
    ...
    |--------------------------------------------------------------------------
    |
    | This value is the version of Nova that is being used. This can be
    | useful for displaying version information in the footer.
    |
    */

    'version' => env('NOVA_VERSION', '4.x'),
    ...
    */
    ...
    'brand' => [
        'logo' => resource_path('/img/logo-montagna-servizi.svg'),
        'colors' => [
            "400" => "24, 182, 155, 0.5",
            "500" => "24, 182, 155",
            "600" => "24, 182, 155, 0.75",
