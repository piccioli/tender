...
echo "-------------------------"
echo "  setup_env.sh  - Configura l'ambiente locale (.env -> .env.local)"
echo ""
...
echo "-------------------"
echo "  deploy.sh    - Deploy completo in produzione"
echo "  rollback.sh  - Rollback a commit specifico"
echo ""
...
echo "--------------------"
echo "  ./scripts/setup_env.sh                # Configura ambiente locale"
...
echo "  ./scripts/deploy.sh                   # Deploy in produzione"
echo ""
...
echo "------------------"
echo "  Per configurazione ambiente: ./scripts/setup_env.sh"
